...
(function() {
  var load_sirius_classes, sirius_classes_with_extensions, sirius_classes_without_extensions, sirius_map_view_classes, sirius_model_view_classes;
  ...
  sirius_map_view_classes = ['AppView', 'ContextMenuItemView', 'ContextMenuView', 'FileUploadView', 'LayersMenuView', 'LayersMenuViewItem', 'MapLinkView', 'MapMarkerView', 'MapNetworkView', 'MapNodeView', 'MapSensorView', 'MapControllerView', 'MapEventView', 'MapSignalView', 'Util', 'TreeView', 'TreeParentItemView', 'TreeChildItemView', 'NavBarView', 'NavParentItemView', 'NavChildItemView'];

  sirius_model_view_classes = ['MapNetworkModel'];
  ...
  load_sirius_classes = function(after) {
    return head.js("js/Sirius.js", function() {
      ...
      class_paths = class_paths.concat(_.flatten(_.map(sirius_model_view_classes, function(cname) {
        return "js/" + cname + ".js";
      })));
